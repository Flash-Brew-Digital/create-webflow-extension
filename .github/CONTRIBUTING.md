# Contributing to Create Webflow Extension

Thank you for your interest in contributing to this CLI tool! We welcome contributions of all kinds, whether it's reporting bugs, suggesting features, improving documentation, or enhancing the scaffolding experience.
...
- **Suggest features**: Have an idea for improving the CLI experience? We'd love to hear it
- **Improve documentation**: Help make our docs clearer
- **Add features**: Contribute new CLI options or improvements
...
2. Clone your fork locally:
   ...
   ```bash
   git clone https://github.com/your-username/create-webflow-extension.git
   cd create-webflow-extension
   ```
...
1. **Clear conventional title**: Describe what changed (e.g., `feat: add --template flag`)
...
- `feat: add --template flag for custom templates`
- `fix: resolve issue with pnpm detection`
